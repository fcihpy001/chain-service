...
func (_Token *TokenCaller) Generator(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "generator")
...
//
// Solidity: function generator() pure returns(string)
func (_Token *TokenSession) Generator() (string, error) {
	return _Token.Contract.Generator(&_Token.CallOpts)
}

// Generator is a free data retrieval call binding the contract method 0x7afa1eed.
//
// Solidity: function generator() pure returns(string)
func (_Token *TokenCallerSession) Generator() (string, error) {
	return _Token.Contract.Generator(&_Token.CallOpts)
}
